    ...
    <footer>
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-bottom-socials">
          <a href="https://www.instagram.com/manbhavanproductions" target="_blank" aria-label="Instagram">
            <svg
          ...
          <a href="https://www.linkedin.com/company/manbhavanproductions/" target="_blank" aria-label="LinkedIn">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
          ...
          <a href="mailto:info@manbhavanproductions.com" target="_blank" aria-label="Email">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
